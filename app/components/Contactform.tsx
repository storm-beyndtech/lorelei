...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (firstName.length <3 || !email.includes('@') || email.length <7 
  ...
  return (
    <div className="bg-white px-6 py-20 sm:py-28 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl text-gray-500">Contact <span className='text-coral-red'>Me</span></h2>
      </div>
      <form action="#" method="POST" className="mx-auto mt-10 max-w-xl sm:mt-14">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                ...
                >
                  {countries.map((country, i) => <option key={i} value={country.code}>{country.code}</option>)}
                </select>
              </div>
              <input
                type="tel"
